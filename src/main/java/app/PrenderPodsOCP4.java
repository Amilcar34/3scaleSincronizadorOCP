...
public class PrenderPodsOCP4 {

	String namespace;

	public PrenderPodsOCP4(String namespace) {
	...
	public void star() {
		...
		for (String artefacto : artefactos) {
			String cmd = "oc scale deployments " + artefacto + " --replicas=1 -n " + this.namespace;
//			System.out.println(cmd);
			String response = Helper.ejecuteResponse(cmd);
//			System.out.println(response);
		}
		System.err.println("En " + namespace + " se PRENDIDO " + artefactos.size() + " DCs");
	}
