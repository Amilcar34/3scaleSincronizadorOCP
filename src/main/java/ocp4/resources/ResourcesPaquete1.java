...
public class ResourcesPaquete1 {
	...
	static {		
		...
		map.put("proxy-prestaciones", "20240228153619-migracion-ocp4-V1.1.0");
		...
		map.put("legacy-medicamentos-api", "20240223132800-migracion-ocp4");
		...
		map.put("sesion-api", "20240228163751-migracion-ocp4-V1.6.0");
